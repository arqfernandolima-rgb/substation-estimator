...
- forma-embedded-view-sdk v0.93.0
...
icon-256.png               — Extension icon (large)
...
npm run build    # builds both pages to dist/
...
```
When not in Forma, use mock data so the app can be tested in a browser.
...
## Cost Data Basis
- RSMeans 2024 Heavy Construction (Gordian)
- AACE Class 5 estimate, accuracy ±30%
- Regional CCI adjustment from project geolocation
...
- Icon not configurable for unpublished/private extensions in APS
